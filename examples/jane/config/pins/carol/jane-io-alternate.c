...
static os_short jane_SERVO_prm[]= {PIN_RESOLUTION, 12, PIN_FREQENCY, 50, PIN_INIT, 2048};
const Pin jane_SERVO = {"SERVO", PIN_PWM, 0, 32, jane_SERVO_prm, sizeof(jane_SERVO_prm)/sizeof(os_short), OS_NULL, &jane_POTENTIOMETER};
static os_short jane_DIMMER_LED_prm[]= {PIN_RESOLUTION, 12, PIN_FREQENCY, 5000, PIN_INIT, 0};
