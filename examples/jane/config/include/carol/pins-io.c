...
static os_short pins_inputs_gazerbeam_prm[]= {PIN_RV, PIN_RV, PIN_INTERRUPT_ENABLED, 1};
...
/* Parameters for pwm */
static os_short pins_pwm_servo_prm[]= {PIN_RV, PIN_RV, PIN_RESOLUTION, 12, PIN_MAX, 4095, PIN_INIT, 2048, PIN_FREQENCY, 50};
static os_short pins_pwm_dimmer_led_prm[]= {PIN_RV, PIN_RV, PIN_RESOLUTION, 12, PIN_MAX, 4095, PIN_INIT, 0, PIN_FREQENCY, 5000};

/* Parameters for uart */
static os_short pins_uart_uart2_prm[]= {PIN_RV, PIN_RV, PIN_TX, 17, PIN_SPEED, 96, PIN_RX, 16};
...
const pins_t pins =
{
  {{4, &pins.inputs.gazerbeam}, /* inputs */
    ...
    {PIN_INPUT, 0, 36, pins_inputs_touch_sensor_prm, sizeof(pins_inputs_touch_sensor_prm)/sizeof(os_short), OS_NULL, OS_NULL PINS_INTCONF_NULL} /* touch_sensor */
  },
  ...
  {{2, &pins.pwm.servo}, /* pwm */
    {PIN_PWM, 0, 22, pins_pwm_servo_prm, sizeof(pins_pwm_servo_prm)/sizeof(os_short), OS_NULL, OS_NULL PINS_INTCONF_NULL}, /* servo */
    {PIN_PWM, 1, 27, pins_pwm_dimmer_led_prm, sizeof(pins_pwm_dimmer_led_prm)/sizeof(os_short), OS_NULL, OS_NULL PINS_INTCONF_NULL} /* dimmer_led */
  },
