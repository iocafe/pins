...
const Pin jane_DIP_SWITCH_3 = {"DIP_SWITCH_3", PIN_INPUT, 0, 34, jane_DIP_SWITCH_3_prm, sizeof(jane_DIP_SWITCH_3_prm)/sizeof(os_short), OS_NULL, &jane_TOUCH_SENSOR};

static os_short jane_DIMMER_LED_prm[]= {PIN_FREQENCY, 5000, PIN_RESOLUTION, 12, PIN_INIT, 0};
const Pin jane_DIMMER_LED = {"DIMMER_LED", PIN_PWM, 1, 33, jane_DIMMER_LED_prm, sizeof(jane_DIMMER_LED_prm)/sizeof(os_short), OS_NULL, &jane_DIP_SWITCH_3};
